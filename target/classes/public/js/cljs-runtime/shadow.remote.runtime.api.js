...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33181 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33181(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_33183 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_33183(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_33184 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_33184(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_33188 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_33188(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33190 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33190(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33193 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33193(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__33178,callback){
var map__33179 = p__33178;
var map__33179__$1 = cljs.core.__destructure_map(map__33179);
var input = map__33179__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33179__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33179__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
