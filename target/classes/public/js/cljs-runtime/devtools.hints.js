...
}catch (e27987){var _e = e27987;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___28067 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___28067)){
var seen_errors_28068 = temp__5802__auto___28067;
if(cljs.core.truth_(seen_errors_28068.has(self))){
} else {
seen_errors_28068.add(self);

var temp__5804__auto___28069 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___28069)){
var sense_28070 = temp__5804__auto___28069;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28070)].join(''));
} else {
}
}
} else {
