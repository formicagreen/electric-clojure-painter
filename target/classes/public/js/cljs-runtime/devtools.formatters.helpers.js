...
var G__28407 = devtools.prefs.pref(v);
v = G__28407;
continue;
} else {
return v;
...
}catch (e28334){var _e__27677__auto__ = e28334;
return false;
}})();
...
}catch (e28338){var _e__27677__auto__ = e28338;
return false;
}})();
...
}catch (e28340){var _e__27677__auto__ = e28340;
return false;
}}
}
});
...
var vec__28354 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28354,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28354,(1),null);
...
return cljs.core.some((function (p1__28369_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28369_SHARP_);
}),template);
});
