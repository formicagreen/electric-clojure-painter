...
var i_33079 = (self__.level + (1));
while(true){
if((i_33079 <= (new_level + (1)))){
(update[i_33079] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_33081 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33081[i]));
} else {
x__$2.forward.push((((i < links_33081.length))?(links_33081[i]):null));
}

if((i < links_33081.length)){
(links_33081[i] = x__$2);
} else {
links_33081.push(x__$2);
}
...
var i_33084 = (0);
while(true){
if((i_33084 <= self__.level)){
var links_33085 = (update[i_33084]).forward;
if((x__$1 === (((i_33084 < links_33085.length))?(links_33085[i_33084]):null))){
(links_33085[i_33084] = (x__$1.forward[i_33084]));

var G__33086 = (i_33084 + (1));
i_33084 = G__33086;
continue;
} else {
var G__33087 = (i_33084 + (1));
i_33084 = G__33087;
continue;
}
} else {
