...
var temp__5802__auto____$1 = (o28031["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o28032 = temp__5802__auto____$1;
return (o28032["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27640__auto__ = f;
return (o__27640__auto__["toString"]).call(o__27640__auto__);
} else {
return "";
}
}catch (e28033){var _ = e28033;
return "";
}});
...
try{var o__27640__auto___28324 = t;
(o__27640__auto___28324["cljs$lang$ctorPrWriter"]).call(o__27640__auto___28324,t,writer);
}catch (e28034){var __28325 = e28034;
}
...
var char_code = (function (){var o__27640__auto__ = (new String(char$));
return (o__27640__auto__["charCodeAt"]).call(o__27640__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27640__auto__ = String;
return (o__27640__auto__["fromCharCode"]).call(o__27640__auto__,subscript_code);
});
/**
...
var o__27640__auto__ = String;
return (o__27640__auto__["fromCharCode"]).call(o__27640__auto__,superscript_code);
});
/**
...
}catch (e28087){var _e__27677__auto__ = e28087;
return false;
}})())){
...
var vec__28089 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28089,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28098){
var vec__28099 = p__28098;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28099,(0),null);
...
var G__28336 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28337 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28336;
remaining_tokens = G__28337;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28096){
...
var vec__28104 = cljs.core.split_with((function (p1__28103_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28103_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28104,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28104,(1),null);
...
var vec__28110 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28110,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28110,(1),null);
...
var vec__28115 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28115,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28115,(1),null);
var vec__28118 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28118,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28118,(1),null);
var vec__28121 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28121,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28121,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28121,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28121,(3),null);
...
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28131,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28131,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28131,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28131,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28131,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28131,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__28139 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28139,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28139,(1),null);
var vec__28142 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28142,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28142,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28150 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28150) : devtools.munging.parse_fn_info_deep.call(null,G__28150));
})()));
}
} else {
return fn_info;
...
var G__28367 = (arity + (1));
var G__28368 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28182){
var vec__28183 = p__28182;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28183,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28183,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28197_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28197_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28198_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28198_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___28380 = arguments.length;
var i__5770__auto___28381 = (0);
while(true){
if((i__5770__auto___28381 < len__5769__auto___28380)){
args__5775__auto__.push((arguments[i__5770__auto___28381]));

var G__28382 = (i__5770__auto___28381 + (1));
i__5770__auto___28381 = G__28382;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28204){
var vec__28205 = p__28204;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28205,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28199){
...
var map__28250 = options;
var map__28250__$1 = cljs.core.__destructure_map(map__28250);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28250__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28250__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28250__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28250__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28251 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28251,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28251,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28251,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28251,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28251,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28251,(5),null);
...
var o__27640__auto__ = f;
return (o__27640__auto__["getBasis"]).call(o__27640__auto__);
});
/**
...
}catch (e28262){var _e__27677__auto__ = e28262;
...
var G__28401 = (obj[cljs.core.first(path)]);
var G__28402 = cljs.core.rest(path);
obj = G__28401;
path = G__28402;
continue;
} else {
...
var _STAR_ = (function (accum,p__28282){
var vec__28283 = p__28282;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28283,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28283,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28303){
var vec__28306 = p__28303;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28306,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28306,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28306,(2),null);
...
var post_process = (function (p__28317){
var vec__28318 = p__28317;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28318,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28318,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28316_SHARP_){
return (obj[cljs.core.first(p1__28316_SHARP_)]);
}),sorted_matches);
